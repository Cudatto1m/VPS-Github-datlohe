    ...
    - name: 🖥️ Cài đặt và chạy TightVNC, noVNC, Cloudflared
      ...
      run: |
        ...
        try {
          ...
          Start-Process msiexec.exe -Wait -ArgumentList '/i tightvnc-setup.msi /quiet /norestart ADDLOCAL="Server" SERVER_REGISTER_AS_SERVICE=1 SERVER_ADD_FIREWALL_EXCEPTION=1 SET_USEVNCAUTHENTICATION=1 VALUE_OF_USEVNCAUTHENTICATION=1 SET_PASSWORD=1 VALUE_OF_PASSWORD=datlohehe SET_ACCEPTHTTPCONNECTIONS=1 VALUE_OF_ACCEPTHTTPCONNECTIONS=1 SET_ALLOWLOOPBACK=1 VALUE_OF_ALLOWLOOPBACK=1'
        ...
        Write-Host "🌌 Access noVNC via remote-link.txt URL (Password: datlohehe)"
    ...
    try {
      await octokit.rest.repos.createDispatchEvent({
        ...
        client_payload: {
          ...
          backup: true,
          created_by: 'datlohehe-vps-manager'
        }
      });
